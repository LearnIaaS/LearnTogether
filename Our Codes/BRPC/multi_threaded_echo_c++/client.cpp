...
DEFINE_int32(thread_num, 1, "Number of threads to send requests");  // TODO 这里修改了，之前是 50。
...
DEFINE_int32(timeout_ms, 1000, "RPC timeout in milliseconds"); // TODO 这里修改了，之前是100。
...
static void* sender(void* arg) {
    ...
    for (int i=0; i<10; i++)
    {
        ...
        if (!cntl.Failed()) {
        	std::cout << response.message() << std::endl; // <------------------------- ArtistQiu
